...
import { 
  ...
  Images, FileText, Download, X, Facebook, MessageCircle
} from 'lucide-react';
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="flex gap-4 mb-8 justify-center flex-wrap">
          ...
          {profile.socials.spotify && <a href={profile.socials.spotify.startsWith('http') ? profile.socials.spotify : `https://open.spotify.com/user/${profile.socials.spotify}`} target="_blank" rel="noopener noreferrer">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" style={{ color: theme.textColor }}>
          ...
          {profile.socials.website && <a href={profile.socials.website} target="_blank" rel="noopener noreferrer"><Globe size={20} style={{ color: theme.textColor }} /></a>}
        </div>
